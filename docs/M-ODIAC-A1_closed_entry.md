...
| `docs/Verbal_Summary_Templates_v1.md` | §3.2 candidate table (ODIAC row removed + M-ODIAC-A1 note); §4.2 helper (co2 branch removed); §6.7 Hansen-clause note updated; §9 worked example (GHG now combustion-proxy driven). |
